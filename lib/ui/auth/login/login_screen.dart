import 'package:ecommerceapp/domain/di.dart';
import 'package:ecommerceapp/ui/auth/login/cubit/login_screen_viewmodel.dart';
import 'package:ecommerceapp/ui/auth/login/cubit/login_states.dart';
import 'package:ecommerceapp/ui/utils/dialogs_utils.dart';
    ...
    return BlocListener<LoginScreenViewModel, LoginStates>(
      ...
      listener: (context, state) {
        if (state is LoginLoadingState) {
          ...
          DialogUtils.hideLoading(context);
          DialogUtils.showMessage(context, 'Login Success',
              title: 'Sucess', posActionName: 'Ok');
        }
      },
      child: Scaffold(
        body: Container(
